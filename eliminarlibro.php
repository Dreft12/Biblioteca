...
<html>
<head>
    <title>Eliminar un libro de la Base de Datos</title>
    <meta charset="utf-8">
...
<div id="wrapper" style="width: 994px">
    <div style="font-family: 'Source Sans Pro', serif;">
        <h2>Eliminar un libro de la Base de Datos</h2>
        <h4>Para realizar la eliminacion de un libro en la base de datos, primero debes buscarlo.</h4>
    </div>
    <span style="font-family: 'Source Sans Pro', sans-serif">
<form action="eliminarlibro.php" method="post" name="modificar">
    ...
    if (isset($_POST['ids']) && isset($_POST['buscar'])) {
        ...
        <input type='submit' class='boton' style='position: relative; top: 16px' value='Eliminar libro'>
        </form>
        </div>
        </span>
        </br><br>";
...
<?php
    if (isset($_POST['ids2']) && isset($_POST['buscar2'])){
        if (isset($_POST['ISBN2'])){
            $_SESSION['Biblioteca']->eliminarLibro($_POST['ids2'], $_POST['buscar2'],$_POST['ISBN2']);
        }
    }
?>
